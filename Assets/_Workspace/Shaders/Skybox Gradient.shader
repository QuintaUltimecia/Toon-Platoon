...
Shader "4U Games/Skybox Gradient"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				float4 lerpResult3 = lerp( _Bottom , _Top , pow( saturate( ( staticSwitch13 * _topPower ) ) , _bottomPower ));
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-792.1788,414.5748;Inherit;False;Property;_topPower;mult;2;0;Create;True;0;0;False;0;1;4.92;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-468.1788,419.5748;Inherit;False;Property;_bottomPower;pwer;3;0;Create;True;0;0;False;0;1;0.11;0;0;0;1;FLOAT;0
